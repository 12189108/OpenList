...
(?U)access_token=(.*)&`,
		...
		{Key: conf.SliceTransmissionSize, Value: "50", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
		{Key: conf.SliceTransmissionCount, Value: "3", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
	}
